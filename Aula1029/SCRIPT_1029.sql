...
emop.salario as Renda,
case
when (emp.salario <=2112) then 0
when (emp.salario >=2826.01 and emp.salario <2826.66) then (emp.salario *0.75)
...
when (emp.salario >=1412.01 and emp.salario <2666.68) then (emp.salario *0.9)
